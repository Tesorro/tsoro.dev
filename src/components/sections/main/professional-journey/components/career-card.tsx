...
export function CareerCard({ description, title, year }: IProps) {
	return (
		<Card className='group border-grey hover:border-border rounded-xl border !bg-transparent py-8 shadow-none transition-all duration-500 ease-in-out hover:shadow-sm'>
